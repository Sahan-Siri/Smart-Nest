...
void loop() {
  ...
  if (Firebase.ready() && signupOK) {
    ...
    //if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0)){
      ...
      // Update Firebase with your data
      // Assuming you have `data` structure defined somewhere
      ...
      //Firebase.RTDB.setFloat(&fbdo, Path + "/Current", int( 0.01 + random(1,13)));
   // }

  // No need to put any code here as the data update task will handle it
  fbdo.clear();
  Firebase.reset()
